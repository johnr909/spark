...
function spark_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'spark' ),
            'description' => __( 'This is a section for the typography', 'spark' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'spark' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','spark' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );

    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'spark' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'spark'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'spark' ),
            'description' => __( 'This is a section for the header banner Image.', 'spark' ),
            'priority' => 40,
        )
    );
    ...
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'spark' ),
            'description' => __( 'This is a section for the header banner Image.', 'spark' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'spark' ),
            'description' => __( 'This is a section for the header banner Image.', 'spark' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_control( 
        'cdn_assets',
        array(
            'label' => __( 'Use CDN for Assets', 'spark' ),
            'description' => __( 'All Bootstrap Assets and FontAwesome will be loaded in CDN.', 'spark' ),
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'spark_logo', array(
        'label'    => __( 'Upload Logo (replaces text)', 'spark' ),
