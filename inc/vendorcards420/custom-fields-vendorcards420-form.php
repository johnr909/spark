...
?>
    <p class="field">
        <label for="vendorName"><?php _e('Vendor Name', 'wp-bootstrap-starter'); ?></label>
        <input id="vendorName" 
               type="text" 
               name="vendorName"
    ...
    <p class="field">
        <label for="vendorDescription"><?php _e('Vendor Description', 'wp-bootstrap-starter'); ?></label>
    ...
    <p class="field">
        <label for="productUrl"><?php _e('Product URL', 'wp-bootstrap-starter'); ?></label>
        <input type="text" 
               name="productUrl" 
               id="productUrl"
