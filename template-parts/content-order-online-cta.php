   ...
   <div class="row">
       ...
       <div class="col-sm-5 col-md coupon rounded online-cta">
		    		...
		    		<div class="online-icon-container step1">
		    			<img src="../wp-content/themes/spark/inc/assets/images/hand2.svg" alt="hand" class="d-block img-hand" width="70%" height="70%">
		    		</div>
        </div><!-- .coupon- -->
        ...
        <div class="col-sm-5 col-md coupon rounded online-cta">
		    		...
		    		<div class="online-icon-container step2">
		    			<img src="../wp-content/themes/spark/inc/assets/images/cart2.svg" alt="cart" class="d-block img-cart" width="90%" height="90%">
		    		</div>
        </div><!-- .coupon -->
        ...
        <div class="col-sm-5 col-md coupon rounded online-cta">
		    		...
		    		<div class="online-icon-containers step3">
		    			<img src="../wp-content/themes/spark/inc/assets/images/bag2.svg" alt="bag" class="d-block img-bag" width="70%" height="70%">
		    		</div>
        </div><!-- .coupon -->
        ...
        <div class="col-sm-5 col-md coupon rounded online-cta">
		    		...
		    		<div class="online-icon-container step4">
		    			<img src="../wp-content/themes/spark/inc/assets/images/emoji2.svg" alt="joint" class="d-block img-joint" width="90%" height="90%">
		    		</div>
        </div><!-- .coupon -->
